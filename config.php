...
$CFG->dbtype    = getenv('MOODLE_DBTYPE') ?: '';                  // 'pgsql', 'mariadb', 'mysqli', 'auroramysql', or 'sqlsrv'
...
$CFG->prefix    = getenv('MOODLE_DBPREFIX') ?: 'mdl_';                   // prefix to use for all table names
$CFG->dboptions = [
    'dbpersist' => getenv('MOODLE_DBPERSIST') ?: false,                   // Should persistent database connections be
    ...
    'dbport'    => getenv('MOODLE_DBPORT') ?: '',                      // The TCP port number to use when connecting
...
$CFG->wwwroot   = getenv('MOODLE_WWWROOT') ?: 'http://example.com/moodle';
